...
def main():
    ...
    # Triangle motifs
    draw.polygon([(128, 30), (80, 110), (176, 110)], fill=(70, 130, 180), outline=(20, 20, 20), width=2)
    draw.polygon([(128, 226), (80, 146), (176, 146)], fill=(60, 140, 90), outline=(20, 20, 20), width=2)
