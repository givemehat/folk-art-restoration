...
def main():
    ...
    for i in range(4):
        img = Image.new(
            "RGB", (256, 256), color=(240 - i * 15, 230 + i * 5, 200 + i * 10)
        )
    ...
    result_lama = subprocess.run(
        [
            ...
            "True",
            "--lambda_style",
            "0.0",  # Style loss off to speed up CPU dry-run
        ],
        capture_output=True,
        text=True,
    )
    ...
    result_restore = subprocess.run(
        [
            ...
            "restore.py",
            "--input",
            "demo_outputs/1_damaged_scratch.png",
            "--output",
            "demo_outputs/restored_1epoch.png",
            "--ground_truth",
            "demo_outputs/0_clean_original.png",
            "--edsr_ckpt",
